...
namespace PNMTD.Migrations
{
    ...
    [Migration("20250404182653_DoneZoneHostLink")]
    partial class DoneZoneHostLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PNMTD.Models.Db.DnsZoneEntryEntity", b =>
                {
                    ...
                    b.Property<int>("NumOfFailuresInARow")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PNMTD.Models.Db.NotificationRuleEventEntity", b =>
                {
                    ...
                    b.Property<DateTime>("LastCleanupEventCreated")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PNMTD.Models.Db.SensorEntity", b =>
                {
                    ...
                    b.Property<string>("SecretReadToken")
                        .HasColumnType("TEXT");

                    b.Property<string>("SecretWriteToken")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PNMTD.Models.Db.DnsZoneEntity", b =>
                {
                    b.HasOne("PNMTD.Models.Db.HostEntity", "Host")
                        .WithMany()
